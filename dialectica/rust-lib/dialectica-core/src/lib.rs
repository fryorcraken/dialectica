...
pub use wire::{
    callee_error, channel_exists_reply, create_identity, create_stoa, error_json,
    generate_identity_slate, get_capabilities, get_capabilities_from_stores, get_stoa, guarded,
    join_stoa, keep_identity, list_stoas, list_threads, list_threads_from_request,
    membership_path_in, no_identity, panic_probe, parse_channel_id, ping, posting_identity,
    publish_post, publish_reply, publish_vote, read_thread, read_thread_from_request, stoa_of,
    version, who_am_i, with_membership_store, with_membership_store_read, KeepTargets,
