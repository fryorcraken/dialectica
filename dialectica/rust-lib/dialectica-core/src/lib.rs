...
pub use wire::{
    ...
    generate_identity_slate, get_capabilities, get_capabilities_from_stores, guarded, join_stoa,
    keep_identity, list_stoas, list_threads, list_threads_from_request, membership_path_in,
    no_identity, panic_probe, parse_channel_id, ping, posting_identity, publish_post,
    publish_reply, publish_vote, read_thread, read_thread_from_request, stoa_of, version, who_am_i,
    with_membership_store, with_membership_store_read, KeepTargets, OnboardingSession, Request,
