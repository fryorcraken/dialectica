...
| Requirement | Test that pins it |
|---|---|
| Every method takes JSON and returns JSON | `every_handler_answers_with_an_object_carrying_exactly_one_top_level_shape` (every handler, well-formed and malformed input each), `version_reports_what_it_was_given`, `ping_echoes_its_payload` |
