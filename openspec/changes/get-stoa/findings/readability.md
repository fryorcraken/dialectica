...
- [ ] **`tester`** — `dialectica/rust-lib/dialectica-core/src/wire.rs:15474` (and `:15589`), `dialectica/rust-lib/dialectica-core/src/stoa_metadata.rs:783` — a third near-identical hand-rolled `OpLog` stub is added by this change, on top of the two the file already had.
