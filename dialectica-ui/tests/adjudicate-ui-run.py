...
because it reads as evidence when it is the absence of evidence. Removing the
`len(steps) != expected` branch below turns exactly the "stopped early" case
green and leaves every other check as it was.
